    ...
    >
      ...
      >
        ...
        <q-btn
          ...
          >
            <q-tooltip :delay="500" content-class="text-bold">Allign Left</q-tooltip>
          ...
          >
            <q-tooltip :delay="500" content-class="text-bold">Allign Right</q-tooltip>
          ...
          >
            <q-tooltip :delay="500" content-class="text-bold">Allign Center</q-tooltip>
          ...
          >
            <q-tooltip :delay="500" content-class="text-bold">Justify</q-tooltip>
