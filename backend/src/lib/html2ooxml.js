...
let parser = new htmlparser.Parser({
  ...
  onattribute(name, value) {
    ...
    if (name == 'style' && value == 'text-align: justify') {
      this.alignstatus='justify'; // Corrected variable name
    } 
    else if (name == 'style' && value == 'text-align: right'){
      this.alignstatus='right'; // Corrected variable name
    }
    else if (name == 'style' && value == 'text-align: center'){
      this.alignstatus='center'; // Corrected variable name
    }
  ...
  ontext(text) {
    ...
    {  
      ...
      { 
        ...
        else if (this.alignstatus=== 'right')
      {
          cRunProperties.text = text;
          cParagraph = new docx.Paragraph({
        ...
        else if (this.alignstatus=== 'center')
      { 
          cRunProperties.text = text;
          cParagraph = new docx.Paragraph({
            alignment: docx.AlignmentType.CENTER,
          ...
          this.alignstatus=''
            ...
            cRunProperties.text = text;
            cParagraph = new docx.Paragraph({alignment: docx.AlignmentType.LEFT,});
